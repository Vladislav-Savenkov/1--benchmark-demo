...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	УПЖКХ_РассылкаКвитанцийНаЭлектроннуюПочтуЛицевыхСчетовСервер.СтопЛистПриСозданииНаСервере(ЭтаФорма, Элементы.ГруппаЭлектроннаяПочта, Объект.АдресЭлектроннойПочты);
...
Процедура ПриЗаписиНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	// МеханизмРассылкиКвитанцийНаЭлекторонныйЯщики
	УПЖКХ_РассылкаКвитанцийНаЭлектроннуюПочтуЛицевыхСчетовСервер.СтопЛистПриЗаписиНаСервере(ЭтаФорма, Объект.АдресЭлектроннойПочты);
	// Конец МеханизмРассылкиКвитанцийНаЭлекторонныйЯщики
	
	Если ЭтаФорма.Модифицированность Тогда
		ПараметрыЗаписи.Вставить("ОповещатьОбИзмененииЛС", Истина);
	КонецЕсли;
...
Процедура ПослеЗаписи(ПараметрыЗаписи)
	...
	Если ПараметрыЗаписи.Свойство("ОповещатьОбИзмененииЛС")
	   И ПараметрыЗаписи.ОповещатьОбИзмененииЛС = Истина Тогда
		Оповестить("ИзменениеЛС", Объект.Ссылка);
	КонецЕсли;
