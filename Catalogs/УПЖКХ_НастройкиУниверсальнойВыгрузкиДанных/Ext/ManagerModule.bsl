...
Процедура ЗаполнитьТекущиеНастрокиПоСсылке(СтруктураНастроек, ТекущаяНастройка)
	...
	|	УПЖКХ_НастройкиУниверсальнойВыгрузкиДанных.ВыгружатьСведенияПоЗакрытымЛицевымСчетам КАК ВыгружатьСведенияПоЗакрытымЛицевымСчетам
	|ИЗ
	...
	Если ВыборкаРеквизитов.Следующий() Тогда
		...
		СтруктураНастроек.Вставить("ВыгружатьСведенияПоЗакрытымЛицевымСчетам", ВыборкаРеквизитов["ВыгружатьСведенияПоЗакрытымЛицевымСчетам"]);
