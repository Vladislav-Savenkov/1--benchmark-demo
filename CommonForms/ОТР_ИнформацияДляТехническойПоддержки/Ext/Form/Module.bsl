...
Процедура СобратьДанные()
	...
	ПараметрыДлительнойОперации.Вставить("ВидПриложения",           УПЖКХ_ТиповыеМетодыКлиент.ВидПриложения());
...
Процедура ФоновоеЗадниеЗавершение(Результат, ДополнительныеПараметры) Экспорт
	...
	Если Не Результат = Неопределено Тогда
		...
		ТекстовыйДокумент = ПолучитьИзВременногоХранилища(Результат.АдресРезультата);
