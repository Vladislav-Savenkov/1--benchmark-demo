...
Функция СформироватьПараметрыЗапроса()
	...
	ТехническаяИнформация = ОТР_ОбращениеВТехническуюПоддержкуПереопределяемый.ИнформацияДляТехническойПоддержкиЖКХ(Организация, ВидПриложения);
...
Процедура ПриОткрытии(Отказ)
	ВидПриложения = УПЖКХ_ТиповыеМетодыКлиент.ВидПриложения();
КонецПроцедуры
