...
Процедура ВыгрузитьДанныеВФайлВолгоградскаяОбласть()
	...
	ФайлВыгрузки.Поля.Добавить("E_N",        "N", 10);
	...
	ФайлВыгрузки.Поля.Добавить("NORM_GH",    "N", 10, 2);
	ФайлВыгрузки.Поля.Добавить("TKO",        "N", 10, 2);
	ФайлВыгрузки.Поля.Добавить("NORM_TKO",   "N", 10, 2);
	ФайлВыгрузки.Поля.Добавить("TARIF_TKO",  "N", 10, 2);
	ФайлВыгрузки.Поля.Добавить("MES_TKO",    "N", 2);
