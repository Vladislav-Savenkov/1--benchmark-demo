...
Функция ПолучитьТаблицуНачислений(МассивЛицевыхСчетов)
	...
	Запрос.УстановитьПараметр("ТаблицаУслуг",        Объект.РеспубликаТатарстан_УслугиВБазе.Выгрузить(, "КодУслугиВОСЗН, УслугаВБазе, ТипНачисления"));
	...
	|	ТаблицаУслуг.ТипНачисления КАК ТипНачисленияНастройки
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	втТаблицаУслуг.УслугаВБазе КАК УслугаВБазе,
	|	втТаблицаУслуг.КодУслугиВОСЗН КАК КодУслугиВОСЗН,
	|	втТаблицаУслуг.ТипНачисленияНастройки КАК ТипНачисленияНастройки,
	|	МАКСИМУМ(ВЫБОР
	...
	|	втТаблицаУслуг.ТипНачисленияНастройки
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	втУслугиСКодамиБезГВС.УслугаВБазе КАК УслугаВБазе,
	|	втУслугиСКодамиБезГВС.КодУслугиВОСЗН КАК КодУслугиВОСЗН,
	|	втУслугиСКодамиБезГВС.ТипНачисленияНастройки КАК ТипНачисленияНастройки,
	|	втУслугиСКодамиБезГВС.КодЕИ КАК КодЕИ
	...
	|	втУслугиСКодамиБезГВС.ТипНачисленияНастройки,
	|	""8""
	|ИЗ
	|	втУслугиСКодамиБезГВС КАК втУслугиСКодамиБезГВС
	|ГДЕ
	...
	|			ИНАЧЕ 0
	|		КОНЕЦ) КАК КоличествоИндивидуальное,
	|	СУММА(ВЫБОР
	|			КОГДА УПЖКХ_НачисленияОбороты.ВидНачисления = ЗНАЧЕНИЕ(Перечисление.УПЖКХ_ВидыНачислений.НачислениеПоОПУ)
	|				ТОГДА УПЖКХ_НачисленияОбороты.Количество
	|			ИНАЧЕ 0
	|		КОНЕЦ) КАК КоличествоОбщедомовое,
	|	СУММА(УПЖКХ_НачисленияОбороты.Количество) КАК КоличествоВсеНачисления,
	|	СУММА(ВЫБОР
	|			КОГДА НЕ УПЖКХ_НачисленияОбороты.ВидНачисления В (ЗНАЧЕНИЕ(Перечисление.УПЖКХ_ВидыНачислений.ПерерасчетНачисления), ЗНАЧЕНИЕ(Перечисление.УПЖКХ_ВидыНачислений.Корректировка), ЗНАЧЕНИЕ(Перечисление.УПЖКХ_ВидыНачислений.КорректировкаПриОтсутствииПоказанийПоИПУ), ЗНАЧЕНИЕ(Перечисление.УПЖКХ_ВидыНачислений.Оплата), ЗНАЧЕНИЕ(Перечисление.УПЖКХ_ВидыНачислений.ЗачетДолговИПереплат), ЗНАЧЕНИЕ(Перечисление.УПЖКХ_ВидыНачислений.НачислениеПоИПУ))
	|				ТОГДА УПЖКХ_НачисленияОбороты.СуммаНачисленияОборот
	|			ИНАЧЕ 0
	|		КОНЕЦ) КАК ОбщедомовоеНачисление,
	|	СУММА(ВЫБОР
	|			КОГДА УПЖКХ_НачисленияОбороты.ВидНачисления = ЗНАЧЕНИЕ(Перечисление.УПЖКХ_ВидыНачислений.НачислениеПоИПУ)
	|				ТОГДА УПЖКХ_НачисленияОбороты.СуммаНачисленияОборот
	|			ИНАЧЕ 0
	|		КОНЕЦ) КАК ИндивидуальноеНачисление,
	|	СУММА(ВЫБОР
	|			КОГДА УПЖКХ_НачисленияОбороты.ВидНачисления В (ЗНАЧЕНИЕ(Перечисление.УПЖКХ_ВидыНачислений.ПерерасчетНачисления), ЗНАЧЕНИЕ(Перечисление.УПЖКХ_ВидыНачислений.Корректировка), ЗНАЧЕНИЕ(Перечисление.УПЖКХ_ВидыНачислений.КорректировкаПриОтсутствииПоказанийПоИПУ)) И УПЖКХ_НачисленияОбороты.ТипНачисления = ЗНАЧЕНИЕ(Перечисление.УПЖКХ_ТипНачисления.Индивидуальное)
	|				ТОГДА УПЖКХ_НачисленияОбороты.СуммаНачисленияОборот
	|			ИНАЧЕ 0
	|		КОНЕЦ) КАК ИндивидуальныйПерерасчет,
	|	СУММА(ВЫБОР
	|			КОГДА УПЖКХ_НачисленияОбороты.ВидНачисления В (ЗНАЧЕНИЕ(Перечисление.УПЖКХ_ВидыНачислений.ПерерасчетНачисления), ЗНАЧЕНИЕ(Перечисление.УПЖКХ_ВидыНачислений.Корректировка), ЗНАЧЕНИЕ(Перечисление.УПЖКХ_ВидыНачислений.КорректировкаПриОтсутствииПоказанийПоИПУ)) И УПЖКХ_НачисленияОбороты.ТипНачисления = ЗНАЧЕНИЕ(Перечисление.УПЖКХ_ТипНачисления.Общедомовое)
	|				ТОГДА УПЖКХ_НачисленияОбороты.СуммаНачисленияОборот
	|			ИНАЧЕ 0
	|		КОНЕЦ) КАК ОбщедомовойПерерасчет,
	|	СУММА(ВЫБОР
	|			КОГДА УПЖКХ_НачисленияОбороты.ВидНачисления В (ЗНАЧЕНИЕ(Перечисление.УПЖКХ_ВидыНачислений.ПерерасчетНачисления), ЗНАЧЕНИЕ(Перечисление.УПЖКХ_ВидыНачислений.Корректировка), ЗНАЧЕНИЕ(Перечисление.УПЖКХ_ВидыНачислений.КорректировкаПриОтсутствииПоказанийПоИПУ)) И НЕ УПЖКХ_НачисленияОбороты.ТипНачисления = ЗНАЧЕНИЕ(Перечисление.УПЖКХ_ТипНачисления.Общедомовое) И НЕ УПЖКХ_НачисленияОбороты.ТипНачисления = ЗНАЧЕНИЕ(Перечисление.УПЖКХ_ТипНачисления.Индивидуальное)
	|				ТОГДА УПЖКХ_НачисленияОбороты.СуммаНачисленияОборот
	|			ИНАЧЕ 0
	|		КОНЕЦ) КАК ПерерасчетБезРазделения,
	|	СУММА(ВЫБОР
	...
	|	втНачисления.КоличествоИндивидуальное КАК КоличествоИндивидуальное,
	|	втНачисления.КоличествоОбщедомовое КАК КоличествоОбщедомовое,
	|	втНачисления.КоличествоВсеНачисления КАК КоличествоВсеНачисления,
	|	ЕСТЬNULL(втЗакрепленныеСчетчики.НаличиеСчетчика, 0) КАК НаличиеСчетчика,
	|	втНачисления.ИндивидуальноеНачисление КАК ИндивидуальноеНачисление,
	|	втНачисления.ОбщедомовоеНачисление КАК ОбщедомовоеНачисление,
	|	втНачисления.ИндивидуальныйПерерасчет КАК ИндивидуальныйПерерасчет,
	|	втНачисления.ПерерасчетБезРазделения КАК ПерерасчетБезРазделения,
	|	втНачисления.ОбщедомовойПерерасчет КАК ОбщедомовойПерерасчет,
	|	втНачисления.Оплачено КАК Оплачено
	...
	|ГДЕ
	|	втНачисления.ИндивидуальноеНачисление >= 0 И втНачисления.ОбщедомовоеНачисление >= 0
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ РАЗРЕШЕННЫЕ
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	втНачисленияСчетчики.ЛицевойСчет КАК ЛицевойСчет,
	|	втНачисленияСчетчики.Услуга КАК Услуга,
	...
	|	МАКСИМУМ(ВЫБОР
	|		КОГДА втТаблицаНастроек.ТипНачисленияНастройки = ЗНАЧЕНИЕ(Перечисление.УПЖКХ_ТипНачисления.Индивидуальное)
	|			ТОГДА втНачисленияСчетчики.КоличествоИндивидуальное
	|		КОГДА втТаблицаНастроек.ТипНачисленияНастройки = ЗНАЧЕНИЕ(Перечисление.УПЖКХ_ТипНачисления.Общедомовое)
	|			ТОГДА втНачисленияСчетчики.КоличествоОбщедомовое
	|		КОГДА втТаблицаНастроек.ТипНачисленияНастройки = ЗНАЧЕНИЕ(Перечисление.УПЖКХ_ТипНачисления.ПустаяСсылка)
	|			ТОГДА втНачисленияСчетчики.КоличествоВсеНачисления
	|	КОНЕЦ) КАК Количество,
	|	втНачисленияСчетчики.НаличиеСчетчика КАК НаличиеСчетчика,
	|	МАКСИМУМ(ВЫБОР
	|		КОГДА втТаблицаНастроек.ТипНачисленияНастройки = ЗНАЧЕНИЕ(Перечисление.УПЖКХ_ТипНачисления.Индивидуальное)
	|			ТОГДА втНачисленияСчетчики.ИндивидуальныйПерерасчет + ((втНачисленияСчетчики.ИндивидуальноеНачисление / (втНачисленияСчетчики.ИндивидуальноеНачисление + втНачисленияСчетчики.ОбщедомовоеНачисление)) * втНачисленияСчетчики.ПерерасчетБезРазделения)
	|		КОГДА втТаблицаНастроек.ТипНачисленияНастройки = ЗНАЧЕНИЕ(Перечисление.УПЖКХ_ТипНачисления.Общедомовое)
	|			ТОГДА втНачисленияСчетчики.ОбщедомовойПерерасчет + ((втНачисленияСчетчики.ОбщедомовоеНачисление / (втНачисленияСчетчики.ИндивидуальноеНачисление + втНачисленияСчетчики.ОбщедомовоеНачисление)) * втНачисленияСчетчики.ПерерасчетБезРазделения)
	|		КОГДА втТаблицаНастроек.ТипНачисленияНастройки = ЗНАЧЕНИЕ(Перечисление.УПЖКХ_ТипНачисления.ПустаяСсылка)
	|			ТОГДА втНачисленияСчетчики.ПерерасчетБезРазделения + втНачисленияСчетчики.ИндивидуальныйПерерасчет + втНачисленияСчетчики.ОбщедомовойПерерасчет
	|	КОНЕЦ) КАК Перерасчет,
	|	МАКСИМУМ(ВЫБОР
	|		КОГДА втТаблицаНастроек.ТипНачисленияНастройки = ЗНАЧЕНИЕ(Перечисление.УПЖКХ_ТипНачисления.Индивидуальное)
	|			ТОГДА втНачисленияСчетчики.ИндивидуальноеНачисление
	|		КОГДА втТаблицаНастроек.ТипНачисленияНастройки = ЗНАЧЕНИЕ(Перечисление.УПЖКХ_ТипНачисления.Общедомовое)
	|			ТОГДА втНачисленияСчетчики.ОбщедомовоеНачисление
	|		ИНАЧЕ втНачисленияСчетчики.ОбщедомовоеНачисление + втНачисленияСчетчики.ИндивидуальноеНачисление
	|	КОНЕЦ) КАК Начислено,
	...
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ втТаблицаНастроек КАК втТаблицаНастроек
	...
	|ЕСТЬNULL(втТаблицаНастроек.КодУслугиВОСЗН, """"),
	|ЕСТЬNULL(втТаблицаНастроек.КодЕИ, """"),
	|втНачисленияСчетчики.Тариф,
	|втНачисленияСчетчики.Оплачено,
	|ЕСТЬNULL(втДействиеУслуг.УслугаДействует, ""0""),
	|ЕСТЬNULL(втНаличиеОплатПоУлуге.БылиОплатыЗаПоследнийМесяц, ""0""),
	|ЕСТЬNULL(втНаличиеСоглашения.ЕстьСоглашение, ""0""),
	|втНачисленияСчетчики.КоличествоИндивидуальное,
	|втНачисленияСчетчики.НаличиеСчетчика";
...
Функция ПолучитьТаблицуПерерасчетов(ТаблицаНачислений)
	...
	|	ТаблицаУслуг.КодУслугиВОСЗН КАК КодУслугиВОСЗН,
	|	ТаблицаУслуг.УслугаВБазе КАК УслугаВБазе,
	|	ТаблицаУслуг.ТипНачисления КАК ТипНачисления
	|ПОМЕСТИТЬ втТаблицаУслуг
	|ИЗ
	|	&ТаблицаУслуг КАК ТаблицаУслуг
	|;
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	втТаблицаНачисленийСвернуть.ЛицевойСчет КАК ЛицевойСчет,
	|	втТаблицаНачисленийСвернуть.Услуга КАК Услуга,
	|	втТаблицаНачисленийСвернуть.Тариф КАК Тариф,
	|	втТаблицаНачисленийСвернуть.КодЕИ КАК КодЕИ,
	|	втТаблицаНачисленийСвернуть.Перерасчет,
	|	втТаблицаНачисленийСвернуть.Количество,
	|	втТаблицаНачисленийСвернуть.НаличиеСчетчика КАК НаличиеСчетчика
	|ПОМЕСТИТЬ втТаблицаНачислений
	|ИЗ
	|	втТаблицаНачисленийСвернуть
	|СГРУППИРОВАТЬ ПО
	|	втТаблицаНачисленийСвернуть.ЛицевойСчет,
	|	втТаблицаНачисленийСвернуть.Услуга,
	|	втТаблицаНачисленийСвернуть.Тариф,
	|	втТаблицаНачисленийСвернуть.КодЕИ,
	|	втТаблицаНачисленийСвернуть.НаличиеСчетчика,
	|	втТаблицаНачисленийСвернуть.Количество,
	|	втТаблицаНачисленийСвернуть.Перерасчет
	|;
	|
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	втПерерасчеты.ЛицевойСчет КАК ЛицевойСчет,
	|	втТаблицаУслуг.КодУслугиВОСЗН КАК КодУслугиВОСЗН,
	...
	|	МАКСИМУМ(втТаблицаНачислений.Количество) КАК Количество,
	|	МАКСИМУМ(втТаблицаНачислений.НаличиеСчетчика) КАК НаличиеСчетчика,
	|	МАКСИМУМ(втТаблицаНачислений.Перерасчет) КАК Перерасчет
	|ИЗ
	...
	|		ПО втПерерасчеты.Услуга = втТаблицаУслуг.УслугаВБазе И (втПерерасчеты.ТипНачисления = втТаблицаУслуг.ТипНачисления ИЛИ втТаблицаУслуг.ТипНачисления = ЗНАЧЕНИЕ(Перечисление.УПЖКХ_ТипНачисления.ПустаяСсылка))
	|СГРУППИРОВАТЬ ПО
