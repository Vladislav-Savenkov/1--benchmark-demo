...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	УПЖКХ_ПодключаемыеЭлементыФормСервер.ДобавитьГиперссылкуНаФормуПовторнойОтправкиПароляНаСервисеРарус(ЭтаФорма, Элементы.ГруппаГиперссылкаНаПолучениеПароля);
