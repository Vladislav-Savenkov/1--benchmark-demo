...
Функция ДанныеЗаполненыКорректно(Отказ)
	...
	ИначеЕсли ТекущаяСтраница = Элементы.СтраницаЛицевойСчет Тогда
		...
		Если НЕ ПроверитьКорректностьУстановленныхДолейЛицевыхСчетовНаПомещении() Тогда
...
Функция СоздатьДокументУстановкиСобственников()
	...
	// Было исправлено вышеописанное для исправления ошибки, возникающей при содании документа 31.12.20ХХ 23:59:59
	// на секунду ранее документа открытия лс, в случае когда период закрыт по 31.12.20ХХ. 
