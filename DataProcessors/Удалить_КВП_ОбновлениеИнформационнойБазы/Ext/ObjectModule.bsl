...
Процедура ЗаполнитьОбязательныеПоляВНастройкахФормированияПлатежногоДокумента_3_0_41_13()
	...
	|	ВЫБОР
	|		КОГДА (УПЖКХ_НастройкиФормированияПлатежногоДокумента.УдалитьОтображатьКонтрольнуюСуммуПоОсн
	|				ИЛИ УПЖКХ_НастройкиФормированияПлатежногоДокумента.УдалитьОтображатьКонтрольнуюСуммуПоКР)
	...
	|			ИЛИ (УПЖКХ_НастройкиФормированияПлатежногоДокумента.УдалитьОтображатьКонтрольнуюСуммуПоОсн
	|				ИЛИ УПЖКХ_НастройкиФормированияПлатежногоДокумента.УдалитьОтображатьКонтрольнуюСуммуПоКР)
	|				И УПЖКХ_НастройкиФормированияПлатежногоДокумента.СхемаДляРасчетаКонтрольнойСуммы = """"
