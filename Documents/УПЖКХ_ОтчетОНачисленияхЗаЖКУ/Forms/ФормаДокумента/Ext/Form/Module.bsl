...
Процедура УстановитьДоступность()
	...
	Элементы.ГруппаЛеваяЧасть.Доступность       = НЕ Объект.ОтчетСдан;
	Элементы.ГруппаОбъектУслуга.Доступность     = НЕ Объект.ОтчетСдан;
...
Процедура УстановитьОтборДетальныхТабличныхЧастей(Элемент)
	...
	Если НЕ Элемент.ТекущиеДанные = Неопределено Тогда
		...
		Элементы.ГруппаПлательщики.ЗаголовокСвернутогоОтображения = "Плательщик: " + Строка(Элемент.ТекущиеДанные.Плательщик) + " " + Строка(Элемент.ТекущиеДанные.ЛицевойСчет);
	Иначе
		...
		Элементы.ГруппаПлательщики.ЗаголовокСвернутогоОтображения = "";
	КонецЕсли;
...
Функция ПолучитьКодОрганизации(ДатаОтчета, ОрганизацияОтчета)
	
	КодОрг = РегистрыСведений.УПЖКХ_НастройкиВыгрузкиВГЦЖС.ПолучитьКодОрганизации(ДатаОтчета, ОрганизацияОтчета, Истина);
	Возврат КодОрг;
...
Процедура СохранитьНаДискПродолжение()
	...
	КодОрганизации = ПолучитьКодОрганизации(Объект.Дата, Объект.Организация);
