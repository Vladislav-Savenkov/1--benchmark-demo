...
Процедура ТаблицаСоставШКПоОсновнымУслугамПриОкончанииРедактирования(Элемент, НоваяСтрока, ОтменаРедактирования)
	...
	Если Элемент.ТекущиеДанные <> Неопределено И Не ОтменаРедактирования Тогда
		...
		Иначе
			ОтредактироватьТаблицуСоставаШК(Элемент.ТекущиеДанные, "ТаблицаСоставШКПоОсновнымУслугам", "СоставШтрихкодаПоОсн");
		КонецЕсли;
...
Процедура ТаблицаСоставШКПоУслугамКапремонтаПриОкончанииРедактирования(Элемент, НоваяСтрока, ОтменаРедактирования)
	...
	Если Элемент.ТекущиеДанные <> Неопределено И Не ОтменаРедактирования Тогда
		...
		Иначе
			ОтредактироватьТаблицуСоставаШК(Элемент.ТекущиеДанные, "ТаблицаСоставШКПоУслугамКапремонта", "СоставШтрихкодаПоКР");
		КонецЕсли;
...
//
&НаКлиенте
Процедура ОтредактироватьТаблицуСоставаШК(ТекущаяСтрока, НаименованиеТаблицы, НаименованиеСоставаШК)
...
Процедура ЗаполнитьРеквизитыПоУмолчанию()
	...
	// Штрихкод
	Запись.ВидШтрихкода                       = ПредопределенноеЗначение("Перечисление.КВП_ВидыШтрихкодовДляКвитанций.QR");
...
Процедура УстановитьВидимостьЭлементовПриИзмененииВариантаОпределенияФормата()
	...
	Если Запись.ВидШтрихкода = ПредопределенноеЗначение("Перечисление.КВП_ВидыШтрихкодовДляКвитанций.QR") Тогда
		Элементы.СтраницыНастроекПоВидамШтрихкода.ТекущаяСтраница = Элементы.СтраницаQRШК;
	Иначе
		Элементы.СтраницыНастроекПоВидамШтрихкода.ТекущаяСтраница = Элементы.СтраницаОдномерныйШК;
	КонецЕсли;
