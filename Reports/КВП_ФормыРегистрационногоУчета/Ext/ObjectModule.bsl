...
Функция СобратьОбщиеСведенияПоПроживающему(_Проживающий, _Дата)
	...
	// куда выбыл
	МестоВыбытия = ПолучитьСокрАдрес(_Проживающий, Перечисления.КВП_ВидыАдресов.Выбытие, "Выб", _Дата);
...
Функция СобратьСведенияПоПроживающему_Ф6(_Проживающий, Собственник = Неопределено, _ДопПараметрыПечати)
	...
	РазделитьТекстНаДвеСтроки(СведенияПоПроживающему.ПредставлениеВыб, 30, АдресВыбытия_3_1, АдресВыбытия_3_2);
	
	АдресРегистрации_1 = "";
	АдресРегистрации_2 = "";
	РазделитьТекстНаДвеСтроки(СведенияПоПроживающему.ПредставлениеРег, 60, АдресРегистрации_1, АдресРегистрации_2);
	
	АдресРегистрации_3 = "";
	АдресРегистрации_4 = "";
	РазделитьТекстНаДвеСтроки(СведенияПоПроживающему.ПредставлениеРег, 20, АдресРегистрации_3, АдресРегистрации_4);
	...
	СведенияПоПроживающему.Вставить("АдресВыбытия_3_1",  АдресВыбытия_3_1);
	СведенияПоПроживающему.Вставить("АдресВыбытия_3_2",  АдресВыбытия_3_2);
	СведенияПоПроживающему.Вставить("АдресРегистрации_3", АдресРегистрации_3);
	СведенияПоПроживающему.Вставить("АдресРегистрации_4", АдресРегистрации_4);
