...
Функция ПолучитьТекущиеИОбщиеДанныеПоОбъекту924(Знач СтруктураОбщихТаблиц, Знач ОбщиеДанные, Знач СтруктураНастроек)
	...
	УПЖКХ_ПечатьКвитанцийСервер.ЗаполнитьСведенияОбИсполнителе(ОбщиеДанныеПоКР, СтруктураНастроек);
	...
	врОбщиеДанные.Вставить("ДопИнформация",              ОбщиеДанные.ДопИнформация);
	врОбщиеДанные.Вставить("ДопИнформацияИсполнителяКР", ОбщиеДанные.ДопИнформацияИсполнителяКР);
	врОбщиеДанные.Вставить("ДопИнформацияКР",            ОбщиеДанные.ДопИнформацияКР);
	
	УПЖКХ_ПечатьКвитанцийСервер.ЗаполнитьСведенияОбИсполнителе(ОбщиеДанные, СтруктураНастроек);
	УПЖКХ_ПечатьКвитанцийСервер.ЗаполнитьСведенияОбИсполнителе(врОбщиеДанные, СтруктураНастроек);
...
Функция ПолучитьОбластьРаздел1Приказ924пр(Макет, ОбщиеДанные, СтруктураНастроек)
	...
	Если ЗначениеЗаполнено(СтруктураНастроек.ИсполнительРасчетов)
	   И НЕ СтруктураНастроек.Организация = СтруктураНастроек.ИсполнительРасчетов Тогда
...
Функция ПолучитьОбластьРаздел1Приказ454(Макет, ОбщиеДанные, СтруктураНастроек)
	...
	Если ЗначениеЗаполнено(СтруктураНастроек.ИсполнительРасчетов)
	   И НЕ СтруктураНастроек.Организация = СтруктураНастроек.ИсполнительРасчетов
	   И НЕ ОбщиеДанные.КвитанцияНаКР Тогда
		Область = ПолучитьОбластьРаздел1ИсполнительРасчетовПриказ454(Макет, ОбщиеДанные, СтруктураНастроек);
		ВывестиОбласть(ТабличныйДокумент, Область, Истина);
	КонецЕсли;
