...
// Процедура открывает статью по настройке формирования квитанций в браузере.
//
&НаКлиенте
Процедура ВидеоПоНастройкеФормированияКвитанцийНажатие(Элемент)
	
	ИнтернетАдрес = "https://vgkh.ru/faq-1s-zhkh/seriya_obuchayushchikh_vebinarov_3_0/urok-8-kvitancii-izveshcheniya-shtrihkod/";
...
КонецПроцедуры //ВидеоПоНастройкеФормированияКвитанцийНажатие()
